...
public class ParkingService {
    ...
    //   assert lotId.isEmpty()|| vehicleOpt.isEmpty(): "parking lor or vehicle not found";
    ...
    public String checkOutVehicle(String licensePlate) {
        ...
        ParkingEntity lot = parkingLotRepository.findById(record.getLotId()).orElseThrow(()->
    ...
    public ParkingEntity getParkingLotInfo(String lotId) {
        return parkingLotRepository.findById(lotId).orElseThrow(()-> new EntityNotFoundException("Lot ID not found"));
    }
